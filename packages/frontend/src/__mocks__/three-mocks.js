// Mock Vector3
const Vector3 = jest.fn().mockImplementation((x = 0, y = 0, z = 0) => ({
  x, y, z,
...
// Mock Quaternion
const Quaternion = jest.fn().mockImplementation((x = 0, y = 0, z = 0, w = 1) => ({
  x, y, z, w,
  set: jest.fn().mockReturnThis(),
...
// Mock Euler
const Euler = jest.fn().mockImplementation((x = 0, y = 0, z = 0, order = 'XYZ') => ({
  x, y, z, order,
  set: jest.fn().mockReturnThis(),
